  ...
  return (
    <>
      <div className="flex flex-col gap-y-16">
        <div>
          <h1 className="text-xl md:text-4xl font-semibold mb-5">
            Global Crypto Statistics
          </h1>
          <div className="grid grid-col-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
            <div className="shadow-lg p-5 flex flex-col gap-y-1 items-center rounded-2xl transition-shadow duration-300 hover:shadow-2xl">
